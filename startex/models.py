...
class StartEx_Plan(models.Model):
    ...
    def get_open_url(self):
        return reverse(
            "startex:create_list_sx_unit_detail",
            kwargs={
                "pk": self.pk,
            }
        )
...
class SX_Vehicle_Data(models.Model):
    ...
    def get_update_url2(self):
        return reverse(
            "startex:_update_sx_vehicle_data",
            kwargs={
                "pk": self.pk,
            }
        )
    ...
    def get_delete_url2(self):
        return reverse(
            "startex:_delete_sx_vehicle_data",
            kwargs={
                "pk": self.pk,
            }
        )
...
class SX_Unit_Detail(models.Model):
    ...
    # def get_detailview_url(self):
    #     return reverse(
    #         "startex:detailview_sx_unit_detail",
    #         kwargs={
    #             "pk": self.pk,
    #         }
    #     )
    ...
    def get_update_url2(self):
        return reverse(
            "startex:_update_sx_unit_detail",
            kwargs={
                "pk": self.pk,
            }
        )
    ...
    def get_delete_url2(self):
        return reverse(
            "startex:_delete_sx_unit_detail",
            kwargs={
                "pk": self.pk,
            }
        )
...
class SX_Vehicle_Detail(models.Model):
    ...
    # def get_detailview_url(self):
    #     return reverse(
    #         "startex:detailview_sx_vehicle_detail",
    #         kwargs={
    #             "pk": self.pk,
    #         }
    #     )
    ...
    def get_update_url2(self):
        return reverse(
            "startex:_update_sx_vehicle_detail",
            kwargs={
                "pk": self.pk,
            }
        )
    ...
    def get_delete_url2(self):
        return reverse(
            "startex:_delete_sx_vehicle_detail",
            kwargs={
                "pk": self.pk,
            }
        )
